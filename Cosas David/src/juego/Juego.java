...
public class Juego extends Canvas implements Runnable{ //Canvas = Superficie especializada de Java para dibujar con pocos recursos del sistema
	...
	//Añadimos un identificador de serie por defecto (Java debe saber que se utiliza esta clase aunque se modifique
	...
	private Juego() {
		setPreferredSize(new Dimension(ANCHO, ALTO)); //Fijamos el tamaño de la ventana
		...
		ventana.setLayout(new BorderLayout()); //Añadirle un diseño a la ventana
