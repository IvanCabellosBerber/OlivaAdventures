...
public class HojaSprites {
	...
	public HojaSprites(final String ruta, final int ancho, final int alto) {
		...
		pixeles = new int[ancho * alto]; //Array que tendra mismo tama�o que pixeles nuestra imagen
		...
		try {
			...
			/*Consructor complto (Posicion X inicial, Posicion Y inicial, ancho, alto, array a utilizar para guardar la informacion,
			 offset (hasta que punto corregir la posicion), scansize (tama�o de escaneo, hasta donde queremos leer de cada linea
